  ...
  return (
    <div className='container mx-auto py-2 px-6 md:px-4'>
      <div className='flex justify-between items-center'>
        <div>
          <h2 className='font-semibold text-xl text-[#f5f5f5]'>Overall Performance</h2>
          <p className='text-sm text-[#ababab]'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nemo, asperiores.</p>
        </div>
                ...
                <div className='flex justify-between items-center'>
                  ...
                  <div className='flex items-center gap-1'>
                    <svg
                     ...
                     >
                       <path d={metric.isIncrease ? "M5 15l7-7 7-7-7": "M19 9l-7 7-7-7"} />
                    </svg>
      ...
      <div className='flex flex-col justify-between mt-12'>
        <div>
          <h2 className='font-semibold text-xl text-[#f5f5f5]'>Item Details</h2>
          <p className='text-sm text-[#ababab]'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nemo, asperiores.</p>
        </div>
        <div  className='mt-6 grid grid-cols-4 gap-4'>
