  ...
  return (
    <section className='bg-[#1f1f1f] h-[calc(100vh-5rem)] overflow-hidden'>
      <div className='flex items-center justify-between px-10 py-4'>
        ...
        <div className='flex justify-arrount items-center gap-4'>
        ...
        <button onClick={() => setStatus('inprogress')} className={`text-[#ababab] text-lg ${status === "inprogress" && "bg-[#383838] rounded-lg px-5 py-2"} rounded-lg px-5 py-2 font-semibold`}>In Progress</button>
