...
const OrderCard = () => {
  return (
    <div className='w-[450px] bg-[#262626] p-4 rounded-lg '>
        ...
        <button className='bg-[#f6b100] p-3 text-xl font-bold rounded-lg'>
           ...
           <div className='flex items-center justify-between w-[100%]'>
               ...
               <div className='flex items-end flex-col gap-2'>
                   <p className='text-green-600 bg-[#2e4a40] px-2 py-1 rounded-lg'><FaCheckDouble className='inline mr-2'/> Ready
                   </p>
           ...
           <hr className='text-[#ababab] w-full mt-4 border-t-1 border-gray-500'/>
